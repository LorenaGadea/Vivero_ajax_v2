...
?>
    ...
    <body>
        <div class="container-fluid" id="main">
            ...
            <form name="gestionAlquiler" id="gestionAlquiler">
	      ...
	      <select class="form-control" name="selId" id="selector"></select><br>
              ...
              <div class="row">
                ...
                <div class="col-6">
                  <input class="form-control" type="date" name="txtFechaInicial" id="txtFechaInicial" required>
                </div>
              </div>
              <div class="row">
                <div class="col-6">
                ...
                <div class="col-6">
                  <input class="form-control" type="date" name="txtFechaFinal" id="txtFechaFinal" required>
                </div>
              </div>
	            <input class="btn btn-dark" type="button" value="Borrar " name="btnBorrar">
              <input class="btn btn-dark" type="button" value="Modificar " name="btnModificar">
            </form>
        </div>
        </div>
    <?php } ?>
    <script src="JS/plantarum.js"></script>
    <script src="JS/gestionAlquiler.js"></script>
    </body>
